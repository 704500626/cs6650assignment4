...
public class BloomOnlyAggregation implements AggregationStrategy {
    ...
    public BloomOnlyAggregation(Configuration config, RedisCacheClient cache) throws SQLException {
        this.config = config;
        this.cache = cache;
    ...
    public void run() throws SQLException {
        ...
        cache.createFilter(bf3Temp, config.REDIS_BLOOM_FILTER_CAPACITY, config.REDIS_BLOOM_FILTER_ERROR_RATE);
        cache.createFilter(bf4Temp, config.REDIS_BLOOM_FILTER_CAPACITY, config.REDIS_BLOOM_FILTER_ERROR_RATE);
    ...
    public static void main(String[] args) throws Exception {
        ...
        AggregationStrategy bloomOnly = new BloomOnlyAggregation(config, cacheClient);
