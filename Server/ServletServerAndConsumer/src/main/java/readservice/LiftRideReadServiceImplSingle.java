...
public class LiftRideReadServiceImplSingle extends SkierReadServiceGrpc.SkierReadServiceImplBase {
    ...
    public LiftRideReadServiceImplSingle(Configuration config) {
        this.config = config;
