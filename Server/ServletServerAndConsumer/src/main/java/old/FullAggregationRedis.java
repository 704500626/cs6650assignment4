...
// TODO set batch size
public class FullAggregationRedis implements AggregationStrategy {
    private final Configuration config;
    private final RedisCacheClient cache;
    private final Connection conn;
    private final Gson gson = new Gson();

    public FullAggregationRedis(Configuration config, RedisCacheClient cache) throws SQLException {
        this.config = config;
        this.cache = cache;
    ...
    private void aggregateUniqueSkiers(Connection conn) throws SQLException {
        try (PreparedStatement stmt =
            ...
            cache.createFilter(tmpBloom, config.BLOOM_FILTER_CAPACITY, config.BLOOM_FILTER_ERROR_RATE);
