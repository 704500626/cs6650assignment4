...
CREATE TABLE IF NOT EXISTS LiftRides (
    ...
    FOREIGN KEY (skier_id) REFERENCES Skiers(skier_id),
    FOREIGN KEY (resort_id, lift_id) REFERENCES Lifts(resort_id, lift_id),
    FOREIGN KEY (resort_id, season_id) REFERENCES Seasons(resort_id, season_id)
);
